  ...
  return (
    <Html lang="en">
      <Head>
        ...
        <link rel="shortcut icon" href="/icon-2566.png" type="image/png" />
        <link rel="shortcut icon" href="/icon-2566.png" type="image/svg+xml" />
        <link rel="apple-touch-icon" href="/icon-2566.png" />
